...
class MSResNet_Partial(nn.Module):
    def __init__(self, input_channel, window_size, batch_size, layers=[1, 1, 1, 1], num_classes=10):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64

        if window_size == 128:
            maxpool3_kernel_size = 4
            maxpool5_kernel_size = 16
            maxpool7_kernel_size = 16

        super(MSResNet_Partial, self).__init__()
...
class MSResNet(nn.Module):
    def __init__(self, input_channel, window_size, layers=[1, 1, 1, 1], num_classes=10):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
